...
<div class="panel-heading">เพิ่มข้อมูลสินค้า</div>
...
<?= Form::select('typeproduct_id', App\TypeProduct::all()->pluck('name', 'id'), null, ['class' =>
'form-control', 'placeholder' => 'กรุณาเลือกประเภทสินค้า...']); ?>
</div>
